...
import com.suna.harrypotter_cardgame.databinding.ActivitySingleplayer4x4Binding
import java.util.*
import kotlin.concurrent.schedule

class Singleplayer4x4Activity : AppCompatActivity() {
    ...
    lateinit var binding: ActivitySingleplayer4x4Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding=ActivitySingleplayer4x4Binding.inflate(layoutInflater)
    ...
    fun controller(imageView: ImageView,String:String,binding: ActivitySingleplayer4x4Binding){
