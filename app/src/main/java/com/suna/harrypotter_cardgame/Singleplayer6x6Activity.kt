...
import com.suna.harrypotter_cardgame.databinding.ActivitySingleplayer6x6Binding
import java.util.*
import kotlin.concurrent.schedule

class Singleplayer6x6Activity : AppCompatActivity() {
    lateinit var binding: ActivitySingleplayer6x6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding=ActivitySingleplayer6x6Binding.inflate(layoutInflater)
            ...
            override fun onFinish() {
                ...
                object : CountDownTimer(45000, 1000) {
                    override fun onTick(millisUntilFinished: Long) {
                        ...
                        isfinish()
                        binding.textView4.setText("süre:"+millisUntilFinished / 1000)
                    }
                    override fun onFinish() {
    ...
    fun controller(imageView: ImageView,String:String,binding: ActivitySingleplayer6x6Binding){
        if(controller2==0){
            controller2++
            str1 = String
            list.add(imageView)
